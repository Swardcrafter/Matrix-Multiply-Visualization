(function() {
    ...
    1: [function(require, module, exports) {
        ...
        function view(calculatorVDom) {
            return calculatorVDom.map(function(calcVNode) {
                return dom_1.div(".app", [dom_1.h1(".title." + styles_1.default.title, "Matrix Multiplication"), calcVNode, dom_1.h2(".footnote." + styles_1.default.footnote, [dom_1.a({
                    attrs: {
    ...
    , {
        "xstream/extra/delay": 103,
        "xstream/extra/dropRepeats": 104
    }],
                ...
                return function startMultiplyReducer(prevState) {
                    if (prevState.step === 0) {
                        return __assign({}, prevState, {
                            ...
                            canInteract: false,
                            fastForwardToEnd: false,
                            matrixA: __assign({}, prevState.matrixA, {
                                editable: false
                            }),
                            matrixB: __assign({}, prevState.matrixB, {
                                editable: false
                            }),
                            matrixC: {
                                editable: false,
                ...
                return function nextStepReducer(prevState) {
                    if (prevState.step >= 1 && prevState.canInteract && prevState.matrixC) {
                        ...
                        return __assign({}, prevState, {
                            step: nextStep,
                            canInteract: false,
                            matrixC: __assign({}, prevState.matrixC, {
            ...
            return action$.map(function(action) {
                return function resizeReducer(prevState) {
                    ...
                    if (action.resizeParam.direction === "row") {
                        nextState[targetMatrix] = __assign({}, prevState[targetMatrix], {
                            values: prevValues.resize(prevValues.numberRows + action.resizeParam.amount, prevValues.numberColumns)
                        })
                    } else {
                        nextState[targetMatrix] = __assign({}, prevState[targetMatrix], {
                            values: prevValues.resize(prevValues.numberRows, prevValues.numberColumns + action.resizeParam.amount)
                        })
                    }
                    return nextState
                }
    ...
    18: [function(require, module, exports) {
        ...
        function getArrayOfButtons(state) {
            ...
            var buttons = [];
            if (step === 0) {
                buttons = [dom_1.div(".multiply." + styles_1.default.multiplyButton, [play_1.default, "Multiply"])]
            } else if (step === 1 && !state.canInteract) {
                buttons = [dom_1.div(".multiply." + styles_1.default.multiplyButtonDisabled, [play_1.default, "Multiply"])]
            } else if (step >= 1 && step <= queries_1.lastCombStep(state) && state.canInteract) {
                buttons = [dom_1.div(".next." + styles_1.default.nextButton, [next_1.default, "Next"]), dom_1.div(".end." + styles_1.default.endButton, [end_1.default, "End"])]
            } else if (step >= 1 && step <= queries_1.lastCombStep(state) + 1 && !state.canInteract) {
                buttons = [dom_1.div(".next." + styles_1.default.nextButtonDisabled, [next_1.default, "Next"]), dom_1.div(".end." + styles_1.default.endButtonDisabled, [end_1.default, "End"])]
            } else if (step === queries_1.lastCombStep(state) + 1 && state.canInteract) {
                buttons = [dom_1.div(".reset." + styles_1.default.resetButton, [reset_1.default, "Reset"])]
            }
            return buttons
        }
        ...
        function renderOperatorGrid(state) {
            ...
            return dom_1.div(".operatorGrid." + styles_2.default.operatorGrid, rows.map(function(row, i) {
                ...
                return dom_1.div("." + styles_1.default.row, row.map(function(cellVal, j) {
                    ...
                    return dom_1.div([dom_1.span(".operator", {
                        class: (_a = {},
        ...
        function maybeRenderMatrixC(matrixC, state) {
            ...
            if (matrixC === null || step === 0 || step === 1 && !state.canInteract) {
                return dom_1.div(".matrixC", {
                    class: (_a = {},
                    _a[styles_1.default.matrixCHidden] = true,
                    _a),
                    style: {
                        opacity: "0.01",
                        marginLeft: "0"
                ...
                return dom_1.div(".matrixC", {
                    class: (_b = {},
                    _b[styles_1.default.matrixC] = true,
                    _b),
                    style: {
    ...
    , {
        ...
        "../styles": 15,
        xstream: 107,
        "xstream/extra/concat": 102,
        "xstream/extra/delay": 103,
        "xstream/extra/dropRepeats": 104,
        "xstream/extra/tween": 106
    }],
    ...
    27: [function(require, module, exports) {
        ...
        (function(Styles) {
            ...
            Styles.cell2 = typestyle_1.style({
                fontSize: Styles.cellFontSize2 + "px"
            });
            Styles.cell3 = typestyle_1.style({
                fontSize: Styles.cellFontSize3 + "px"
            });
            Styles.cell4 = typestyle_1.style({
                fontSize: Styles.cellFontSize4 + "px"
            });
            Styles.cell5 = typestyle_1.style({
                fontSize: Styles.cellFontSize5 + "px"
            });
            Styles.cell6 = typestyle_1.style({
                fontSize: Styles.cellFontSize6 + "px"
            });
            Styles.cell7 = typestyle_1.style({
                fontSize: Styles.cellFontSize7 + "px"
            })
        }
        )(Styles || (Styles = {}));
        exports.default = Styles
    ...
    28: [function(require, module, exports) {
        ...
        function isNumberLengthy(num) {
            return Number(Math.abs(num)).toFixed(0).length > 3 && Number(num).toFixed(2).length > 7
        }
        ...
        function renderCellAsInput(cellValue, i, j) {
            return dom_1.input(".cell." + styles_1.default.cell, {
                key: "cell" + i + "-" + j,
                hook: {
                    insert: updateFontSizeHook,
                    update: updateFontSizeHook
                },
                attrs: {
                    type: "text",
                    "data-row": i,
        ...
        function renderAllCells(state) {
            return state.values.rows.map(function(row, i) {
                return dom_1.div(".row." + styles_1.default.row, {
                    key: "row" + i
                }, row.map(function(cellValue, j) {
                    return dom_1.div(".col", {
                        key: "col" + j
    ...
    39: [function(require, module, exports) {
        ...
        var fromEvent_1 = require("./fromEvent");
        exports.eventTypesThatDontBubble = ["blur", "canplay", "canplaythrough", "durationchange", "emptied", "ended", "focus", "load", "loadeddata", "loadedmetadata", "mouseenter", "mouseleave", "pause", "play", "playing", "ratechange", "reset", "scroll", "seeked", "seeking", "stalled", "submit", "suspend", "timeupdate", "unload", "volumechange", "waiting"];
    ...
    , {
        ...
        xstream: 107,
        "xstream/extra/concat": 102,
        "xstream/extra/sampleCombine": 105
    }],
    ...
    , {
        "snabbdom/modules/attributes": 81,
        "snabbdom/modules/class": 82,
        "snabbdom/modules/dataset": 83,
        "snabbdom/modules/props": 84,
        "snabbdom/modules/style": 85
    }],
                    ...
                    if (Array.isArray(nextState)) {
                        ...
                        for (var i = 0, n = nextState.length; i < n; ++i) {
                            ...
                            if (!dict.has(key)) {
                                ...
                                var scopes = typeof otherScopes === "string" ? (_a = {
                                    "*": otherScopes
                                },
                                _a[name] = onionScope,
                                _a) : __assign({}, otherScopes, (_b = {},
                                _b[name] = onionScope,
                                _b));
                        ...
                        var otherScopes = itemScope(key);
                        var scopes = typeof otherScopes === "string" ? (_c = {
                            "*": otherScopes
                        },
                        _c[name] = onionScope,
                        _c) : __assign({}, otherScopes, (_d = {},
                        _d[name] = onionScope,
                        _d));
                        var sinks = isolate_1.default(itemComp, scopes)(sources);
                        dict.set(key, sinks);
    ...
    68: [function(require, module, exports) {
        (function(global, factory) {
            ...
            function packNodes(ownerID, nodes, count, excluding) {
                ...
                for (var ii = 0, bit = 1, len = nodes.length; ii < len; ii++,
                bit <<= 1) {
                    var node = nodes[ii];
    ...
    94: [function(require, module, exports) {
        ...
        function createMatches(opts) {
            return function matches(selector, node) {
                var _a = typeof selector === "object" ? selector : selectorParser_1.parseSelector(selector)
                  , tag = _a.tag
                  , id = _a.id
    ...
    , {
        "./internal/typestyle": 99,
        "./internal/utilities": 100,
        "./types": 101
    }],
